...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        userRepository.findByEmail("admin@zelixa.com").ifPresentOrElse(
                admin -> {
                    admin.setPassword(passwordEncoder.encode("123456"));
                    userRepository.save(admin);
                    log.info("Updated existing admin user password: admin@zelixa.com");
                },
                () -> {
                    User admin = User.builder()
                            ...
                            .build();
                    userRepository.save(admin);
                    log.info("Created default admin user: admin@zelixa.com");
                });
    }
