          ...
          >
            ...
            <div className="p-6 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white relative">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-black text-sm tracking-tight">shekza AI Assistant</h4>
            ...
            <div className="flex-grow p-6 space-y-4 overflow-y-auto">
              <div className="flex gap-3">
                ...
                <div className="bg-neutral-100 p-4 rounded-2xl rounded-tl-none">
                  <p className="text-xs font-bold text-neutral-700 leading-relaxed">
                    Hello! I'm shekza's AI assistant. How can I help you today? 🌸
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <p className="text-[10px] font-black text-neutral-300 uppercase tracking-widest pr-1">shekza AI</p>
              </div>
            </div>
