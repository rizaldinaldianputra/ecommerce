      ...
      <div className="bg-neutral-900 border-b border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white text-sm font-bold">Download the shekza App</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-10">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-black text-white">Zari<span className="text-pink-400">fa</span></span>
            </Link>
        ...
        <div className="border-t border-neutral-800 mt-16 pt-8 flex flex-col items-center justify-between gap-8 md:flex-row">
          ...
          <div className="flex flex-col items-center gap-4">
            <p className="text-[10px] text-neutral-600 font-medium tracking-wide uppercase italic">© 2026 shekza Studio. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
