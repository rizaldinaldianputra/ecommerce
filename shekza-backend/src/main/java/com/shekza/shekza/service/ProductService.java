...
import com.shekza.shekza.entity.StockTransaction;
import com.shekza.shekza.util.SlugUtils;
...
import com.shekza.shekza.repository.StockTransactionRepository;
...
public class ProductService {
    ...
    public ProductResponse createProduct(ProductRequest request) {
        ...
        if (request.getImages() != null && !request.getImages().isEmpty()) {
            for (String url : request.getImages()) {
                ...
                if (request.getImageUrl() != null && url.equals(request.getImageUrl())) continue;
    ...
    private ProductResponse mapToResponse(Product product) {
        ...
        if (product.getCategory() != null) {
            response.setCategory(com.shekza.shekza.dto.CategoryResponse.builder()
